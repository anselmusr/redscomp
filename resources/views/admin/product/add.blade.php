        ...
        <div class="row min-vh-80">
            <div class="col-lg-8 col-md-10 col-12 m-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="multisteps-form__form" action="{{ url('insert-product') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div>
                                            <div class="input-group input-group-dynamic">
                                                ...
                                                <input type="number" class="form-control w-100" name="original_price">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mt-5">
                                            <div class="input-group input-group-dynamic">
                                                ...
                                                <input type="number" class="form-control w-100" name="selling_price">
                                            </div>
                                        </div>
                                    </div>
