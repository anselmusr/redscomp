                        ...
                        <div class="card-body ">
                            ...
                            <div class="row checkout-form input-group input-group-outline">
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ Auth::user()->address1 }}" name="address1" placeholder="Enter Address 1" required>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <label for="">Address 2</label>
                                    <input type="text" class="form-control" value="{{ Auth::user()->address2 }}" name="address2" placeholder="Enter Address 2" required>
                                </div>
                                <div class="col-md-6 mt-3">
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ Auth::user()->country }}" name="country" placeholder="Enter Country" required>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <label for="">Pin Code</label>
                                    <input type="text" class="form-control" value="{{ Auth::user()->pincode }}" name="pincode" placeholder="Enter Pin Code" required>
                                </div>
                            </div>
                        </div>
                    </div>
